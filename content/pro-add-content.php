<form action="../component/pro_process.php" method="post" enctype="multipart/form-data" >
    <div class="row">
        <div class="col-lg-8">
                <!-- Card -->
                ...
                <div class="card-body">
                    ...
                    <textarea name="description" id="" cols="30" rows="10" style="min-height: 15rem; width: 100%;"></textarea>
                    </div>
                    <!-- End Quill -->
                </div>
                <!-- Body -->
                ...
                <!-- Body -->
                <div class="card-body" >
                    <img src="<?php echo($level);?>assets\svg\illustrations\browse.svg" id="image" width="200" >
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="discount" id="priceNameLabel" placeholder="0.00" aria-label="0.00">
                    </div>
                    </div>
                    <!-- End Form Group -->
                ...
                <div class="card-body">
                    ...
                    <input type="text" class="form-control" name="quantity" id="vendorLabel" placeholder="10" aria-label="">
                    </div>
                    <!-- End Form Group -->
                    ...
                    <input type="date" class="form-control" name="date" id="vendorLabel" placeholder="10" aria-label="">
