      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <!-- Media -->
            <div class="d-sm-flex">
              <img class="avatar avatar-xl avatar-4by3 mb-3 mb-sm-0 mr-4" src="<?php echo($level);?>assets\svg\illustrations\choice.svg" alt="Image Description">
            ...
            <!-- Media -->
            <div class="d-sm-flex">
              <img class="avatar avatar-xl avatar-4by3 mb-3 mb-sm-0 mr-4" src="<?php echo($level);?>assets\svg\illustrations\presenting.svg" alt="Image Description">
            ...
            <!-- Media -->
            <div class="d-sm-flex">
              <img class="avatar avatar-xl avatar-4by3 mb-3 mb-sm-0 mr-4" src="<?php echo($level);?>assets\svg\illustrations\book.svg" alt="Image Description">
