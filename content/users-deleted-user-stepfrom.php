<form class="js-step-form py-md-5" data-hs-step-form-options='{
                ...
                "isValidate": false
              }' action="<?php echo $level.'component/deleted-user.php'?>" method="post" enctype="multipart/form-data" >
            ...
            <div class="col-lg-8">
                ...
                <ul id="addUserStepFormProgress" class="js-step-progress step step-sm step-icon-sm step step-inline step-item-between mb-3 mb-md-5">
                    ...
                    <a class="step-content-wrapper" href="javascript:;" data-hs-step-form-next-options='{
                        ...
                        <span class="step-title">Are you want to deleted?</span>
                        </div>
                    </a>
                    </li>
                </ul>
                ...
                <div id="addUserStepFormContent">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="ID" id="ID" placeholder="Enter ID makes it easier to manage " value="<?php echo $user_detail_row[0]['ID'];?>">
                        </div>
                        </div>
                        <!-- End Form Group -->
                        <!-- Form Group -->
                    ...
                    <div class="card-footer d-flex align-items-center">
                        ...
                        <button type="submit" class="btn btn-danger" >
                            Deleted <i class="tio-chevron-right"></i>
                        </button>
                        </div>
                    </div>
                    <!-- End Footer -->
