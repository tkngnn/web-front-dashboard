<div id="addUserStepFormContent">
                ...
                <div id="addUserStepProfile" class="card card-lg active">
                  ...
                  <div class="card-body">
                      ...
                      <div class="col-sm-9">
                        <div class="d-flex align-items-center">
                          ...
                          <label class="avatar avatar-xl avatar-circle avatar-uploader mr-5" for="avatarUploader">
                            <img id="avatarImg" class="avatar-img" src="<?php echo($level);?>assets\img\160x160\img1.jpg" alt="Image Description">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="organization" id="organizationLabel" placeholder="Enter address">
                      </div>
                    </div>
                    <!-- End Form Group -->
                ...
                <div id="addUserStepBillingAddress" class="card card-lg" style="display: none;">
                  ...
                  <div class="card-body">
                    <!-- Form Group -->
                    <div class="row form-group">
                      <label for="ID" class="col-sm-3 col-form-label input-label">ID</label>

                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="ID" id="ID" placeholder="Enter ID makes it easier to manage ">
                      </div>
                    </div>
                    <!-- End Form Group -->
                    <!-- Form Group -->
                    <div class="row form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" name="user" id="addressLine1Label" placeholder="UserName" aria-label="Your address">
                      </div>
                    </div>
                    <!-- End Form Group -->
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="password" class="form-control" name="pass" id="addressLine1Label1" placeholder="Password" aria-label="Your address">
                      </div>
                    </div>
                    <!-- End Form Group -->
                    ...
                    <!-- End Form Group -->
                     ...
                     <div class="row form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="date" class="form-control" name="date" id="created" placeholder="Account will be effective immediately" >
                      </div>
                    </div>
                    <!-- End Form Group -->
                  ...
                  <div class="card-footer d-flex align-items-center">
                    ...
                    <div class="ml-auto">
                      <button type="submit" class="btn btn-primary" >
                        Create User <i class="tio-chevron-right"></i>
                      </button>
                    </div>
                  </div>
                  <!-- End Footer -->
