<form action="<?php echo $level.'component/pro-fix-process.php'?>" method="post" enctype="multipart/form-data" >
        ...
        <div class="col-lg-8">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <p style="color:black;font-weight:700;"><?php echo $sp_detail_row[0]['ID']?></p>
                        <input type="text" class="form-control" name="SKU" id="SKULabel" placeholder="eg. 348121032" aria-label="eg. 348121032" value="<?php echo $sp_detail_row[0]['ID']?>" hidden="true">
                    </div>
                    <!-- End Form Group -->
                    </div>
        ...
        <div class="position-fixed bottom-0 content-centered-x w-100 z-index-99 mb-3" style="max-width: 40rem;">
            ...
            <div class="card card-sm bg-dark border-dark mx-2">
                ...
                <div class="row justify-content-center justify-content-sm-between">
                    ...
                    <button type="button" class="btn btn-ghost-light mr-2">Discard</button></a>
