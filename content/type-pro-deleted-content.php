...
<div class="row justify-content-lg-center">
          <div class="col-lg-9">
            ...
            <div class="card card-lg mb-3 mb-lg-5">
              ...
              <!-- Body -->
              <div class="card-body">
                <form action="<?php echo $level.'component/deleted_loaisp.php '?>" method="POST" enctype="multipart/form-data">
                  <!-- Form Group -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" class="form-control" name="Parent_id" id="projectNameProjectSettingsLabel2" placeholder="Enter project name here" aria-label="Enter project name here" value="<?php echo$loaisp_detail_row[0]['parent_id'];?>">
