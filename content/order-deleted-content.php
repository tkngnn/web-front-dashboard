<form action="<?php echo $level.'component/deleted-order.php'?>" method="post" enctype="multipart/form-data">
<div class="row">
    <div class="col-lg-8 mb-3 mb-lg-0">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="id" id="productNameLabel" placeholder="Enter ID"  value="<?php echo $order_detail_row[0]['order_id']?>" >
                    </div>
                    <!-- End Form Group -->
