          ...
          <div class="col-md-7 col-lg-5">
            ...
            <div class="card card-lg mb-5">
              <div class="card-body text-center">
                <div class="mb-4">
                  <img class="avatar avatar-xxl avatar-4by3" src="<?php echo($level);?>assets\svg\illustrations\click.svg" alt="Image Description">
                </div>
                ...
                <div class="mt-4 mb-3">
                  <a class="btn btn-primary btn-wide" href="<?php echo($level);?>index.php">Skip now</a>
                </div>
