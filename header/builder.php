                ...
                <div class="text-center">
                  <div class="custom-checkbox-card mb-2">
                    ...
                    <label class="custom-checkbox-card-label" for="layoutSkinsRadio1">
                      <img class="custom-checkbox-card-img" src="<?php echo($level);?>assets\svg\layouts\layouts-sidebar-default.svg" alt="Image Description">
                    </label>
                ...
                <div class="text-center">
                  <div class="custom-checkbox-card mb-2">
                    ...
                    <label class="custom-checkbox-card-label" for="layoutSkinsRadio2">
                      <img class="custom-checkbox-card-img" src="<?php echo($level);?>assets\svg\layouts\layouts-sidebar-dark.svg" alt="Image Description">
                    </label>
                ...
                <div class="text-center">
                  <div class="custom-checkbox-card mb-2">
                    ...
                    <label class="custom-checkbox-card-label" for="layoutSkinsRadio3">
                      <img class="custom-checkbox-card-img" src="<?php echo($level);?>assets\svg\layouts\layouts-sidebar-light.svg" alt="Image Description">
                    </label>
                ...
                <div class="text-center">
                  <div class="custom-checkbox-card mb-2">
                    ...
                    <label class="custom-checkbox-card-label" for="sidebarLayoutOptions1">
                      <img class="custom-checkbox-card-img" src="<?php echo($level);?>assets\svg\layouts\sidebar-default-classic.svg" alt="Image Description">
                    </label>
                    <span class="custom-checkbox-card-text">Default</span>
                  </div>
                </div>
                ...
                <div class="text-center">
                  <div class="custom-checkbox-card mb-2">
                    ...
                    <label class="custom-checkbox-card-label" for="sidebarLayoutOptions2">
                      <img class="custom-checkbox-card-img" src="<?php echo($level);?>assets\svg\layouts\sidebar-compact.svg" alt="Image Description">
                    </label>
                ...
                <div class="text-center">
                  <div class="custom-checkbox-card mb-2">
                    ...
                    <label class="custom-checkbox-card-label" for="sidebarLayoutOptions3">
                      <img class="custom-checkbox-card-img" src="<?php echo($level);?>assets\svg\layouts\sidebar-mini.svg" alt="Image Description">
                    </label>
